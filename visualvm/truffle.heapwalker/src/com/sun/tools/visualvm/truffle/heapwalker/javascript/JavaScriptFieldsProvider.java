...
public class JavaScriptFieldsProvider extends HeapWalkerNode.Provider {
        ...
        for (FieldValue field : fields) {
            if (field instanceof ObjectFieldValue) {
                ...
                if (DynamicObject.isDynamicObject(instance)) {
                    nodes.add(new JavaScriptNodes.JavaScriptDynamicObjectFieldNode(new DynamicObject(instance), field, heap));
                } else {

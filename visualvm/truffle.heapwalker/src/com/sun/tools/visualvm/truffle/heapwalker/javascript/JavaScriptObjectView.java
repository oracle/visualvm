 ...
 */
class JavaScriptObjectView extends NodeObjectsView {
    
    public JavaScriptObjectView(HeapWalkerNode node, HeapContext context, HeapWalkerActions actions) {
        super("javascript_objects", node, context, actions);
    }

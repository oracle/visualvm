...
class CoreDumpOverviewPluggableView extends PluggableViewSupport<CoreDump> {
    ...
    public <X extends CoreDump> boolean allowsNewView(X dataSource, int location) {
        return true;
    }

    <X extends CoreDump> void makeCustomizations(DataViewComponent view, X dataSource) {

 ...
 */
public abstract class DynamicObjectFieldsPlugin extends HeapViewPlugin {
    ...
    public DynamicObjectFieldsPlugin(String name, String description, String viewID, HeapContext context, HeapViewerActions actions) {

...
public class RubyArrayItemsProvider extends TruffleInstancePropertyProvider.ArrayItems<RubyObject, RubyType, RubyHeapFragment, RubyLanguage> {
    
    public RubyArrayItemsProvider() {

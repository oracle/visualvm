 ...
 * @author Tomas Hurka
 */
public class PythonJavaViewPlugin extends HeapViewPlugin {
    ...
    public PythonJavaViewPlugin(HeapContext context, HeapViewerActions actions) {
    ...
    public static class Provider extends HeapViewPlugin.Provider {
        ...
        public HeapViewPlugin createPlugin(HeapContext context, HeapViewerActions actions, String viewID) {
            if (PythonHeapFragment.isPythonHeap(context)) return new PythonJavaViewPlugin(context, actions);
            return null;
        }

...
public abstract class TruffleObjectsView extends HeapViewerFeature {
    ...
    public TruffleObjectsView(String id, HeapContext context, HeapViewerActions actions) {
        ...
        objectsView = new PluggableTreeTableView(id, context, actions, TreeTableViewColumn.classes(heap, true)) {
            protected HeapViewerNode[] computeData(RootNode root, Heap heap, String viewID, HeapViewerNodeFilter viewFilter, List<DataType> dataTypes, List<SortOrder> sortOrders, Progress progress) {
                return TruffleObjectsView.this.computeData(getPreset(), getAggregation(), root, TruffleObjectsView.this.context, viewID, viewFilter, dataTypes, sortOrders, progress);
            }
        };
    }
    ...
    protected abstract HeapViewerNode[] computeData(Preset preset, Aggregation aggregation, RootNode root, HeapContext context, String viewID, HeapViewerNodeFilter viewFilter, List<DataType> dataTypes, List<SortOrder> sortOrders, Progress progress);

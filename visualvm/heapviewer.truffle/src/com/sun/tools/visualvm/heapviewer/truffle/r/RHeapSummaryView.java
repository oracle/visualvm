 ...
 */
public class RHeapSummaryView extends TruffleLanguageSummaryView {

    public RHeapSummaryView(HeapContext context) {
        super(RSupport.createBadgedIcon(HeapWalkerIcons.PROPERTIES), context);
    }
    ...
    public static class Provider extends HeapViewerFeature.Provider {
        ...
        public HeapViewerFeature getFeature(HeapContext context, HeapViewerActions actions) {
            if (RHeapFragment.isRHeap(context))
                return new RHeapSummaryView(context);

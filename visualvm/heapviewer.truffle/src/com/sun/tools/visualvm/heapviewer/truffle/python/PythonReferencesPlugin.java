 ...
 * @author Tomas Hurka
 */
public class PythonReferencesPlugin extends HeapViewPlugin {
    ...
    public PythonReferencesPlugin(HeapContext context, HeapViewerActions actions) {
        super("References", "References", Icons.getIcon(ProfilerIcons.NODE_REVERSE));

        heap = context.getFragment().getHeap();

        objectsView = new TreeTableView("python_objects_references", context, actions, TreeTableViewColumn.instancesMinimal(heap, false)) {
            @Override
    ...
    protected HeapViewerNode[] getNodes(List<FieldValue> fields, HeapViewerNode parent, Heap heap, String viewID, List<DataType> dataTypes, List<SortOrder> sortOrders, Progress progress) {
        return PythonReferencesProvider.getNodes(fields, parent, heap, viewID, dataTypes, sortOrders, progress);
    }
    ...
    public static class Provider extends HeapViewPlugin.Provider {
        ...
        public HeapViewPlugin createPlugin(HeapContext context, HeapViewerActions actions, String viewID) {
            if (PythonHeapFragment.isPythonHeap(context)) {
                return new PythonReferencesPlugin(context, actions);
            }
            return null;
        }

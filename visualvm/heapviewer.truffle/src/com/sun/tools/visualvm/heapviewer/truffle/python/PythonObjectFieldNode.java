 ...
 * @author Tomas Hurka
 */
public class PythonObjectFieldNode extends PythonObjectNode {
    ...
    public PythonObjectFieldNode(PythonObject robject, FieldValue field) {
        super(robject);
        this.field = field;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PythonObjectFieldNode)) return false;
        return field.equals(((PythonObjectFieldNode)o).field);
    }
        ...
        public Renderer(Heap heap) {
            ...
            fieldRenderer = new NormalBoldGrayRenderer() {
                public void setValue(Object value, int row) {
                    PythonObjectFieldNode node = (PythonObjectFieldNode)value;

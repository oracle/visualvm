 ...
 * @author Tomas Hurka
 */
public final class AttachFactory extends ModelFactory<Attach, Application> {
    ...
    public static synchronized AttachFactory getDefault() {
    ...
    public static Attach getAttachFor(Application app) {

...
//    private JSpinner trackEverySpinner;
    private JLabel noSettingsLabel;
...
//        this.application = application;
    ...
    public DataViewComponent.DetailsView getDetailsView() {
        return new DataViewComponent.DetailsView(NbBundle.getMessage(MemorySettingsSupport.class, "LBL_Memory_settings"), null, 20, getPanel(), null); // NOI18N
    }
    ...
    public void setUIEnabled(boolean enabled) {
        ...
        noSettingsLabel.setEnabled(enabled);
...
//        trackEverySpinner.setValue(new Integer(10));
    ...
    private JPanel createPanel() {
        ...
        panelImpl.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
        panelImpl.setLayout(new BorderLayout());
        panelImpl.setOpaque(false);

        noSettingsLabel = new JLabel("No customizable memory settings");
        panelImpl.add(noSettingsLabel, BorderLayout.NORTH);

 ...
 */
public class CoreDumpsContainerDescriptor extends AbstractDataSourceDescriptor {
    
    private static final Image ICON = Utilities.loadImage("com/sun/tools/visualvm/core/ui/resources/coredumps.png", true);
    
    public CoreDumpsContainerDescriptor(CoreDumpsContainer container) {
        super(container);
        
        setName("VM Coredumps");
        setDescription("");
        setIcon(ICON);
    }

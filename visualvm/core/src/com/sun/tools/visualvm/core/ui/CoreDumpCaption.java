 ...
 */
class CoreDumpCaption extends JPanel {
    ...
    public static void setAnimate(boolean animate) {
        CoreDumpCaption.animate = animate;
    }
    ...
    private void setRunning(boolean isRunning) {
        ...
        if (isRunning) {
            if (animate) {
                ...
                presenter.setIcon(new ImageIcon(CoreDumpCaption.class.getResource("/com/sun/tools/visualvm/core/ui/resources/busy-icon4.png")));
            }
        } else {
            if (busyIconTimer != null) busyIconTimer.stop(); // Stop previous animation if still running
            presenter.setIcon(new ImageIcon(CoreDumpCaption.class.getResource("/com/sun/tools/visualvm/core/ui/resources/idle-icon.png")));
        }
    ...
    private void createTimer() {
        ...
        for (int i = 0; i < busyIcons.length; i++) busyIcons[i] = new ImageIcon(CoreDumpCaption.class.getResource("/com/sun/tools/visualvm/core/ui/resources/busy-icon" + i + ".png"));
        busyIconTimer = new Timer(ANIMATION_RATE, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (!animate) {
                    ...
                    if (!CoreDumpCaption.this.isShowing()) return;

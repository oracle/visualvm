 ...
 */
public class DefaultDataSourceContainer<X extends DataSource> extends DefaultDataSourceProvider<X> implements DataSourceContainer<X> {
     ...
     * @param owner
     */
    public DefaultDataSourceContainer(DataSource owner) {
        super(owner);
    }
    

    public <Y extends X> void addDataSource(Y added) {
        addDataSources(Collections.singleton(added));
    }
    ...
    public <Y extends X> void removeDataSource(Y removed) {
        removeDataSources(Collections.singleton(removed));
    }

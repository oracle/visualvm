 ...
 * @author Tomas Hurka
 */
final class CoreDumpsNode extends DefaultExplorerNode<CoreDump> {

    public static final CoreDumpsNode NODE = new CoreDumpsNode();


    private CoreDumpsNode() {
        super("VM Coredumps", new ImageIcon(Utilities.loadImage("com/sun/tools/visualvm/core/ui/resources/coredumps.png", true)), 20);
    }

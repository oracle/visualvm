 ...
 */
public class ApplicationDescriptor extends AbstractDataSourceDescriptor<Application> {
    
    public ApplicationDescriptor(Application application) {
        super(application);
        
        setName(ApplicationTypeFactory.getApplicationTypeFor(application).getName());

 ...
 */
public class ProfilerProgressDisplayer extends JPanel {
    //~ Static fields/initializers -----------------------------------------------------------------------------------------------

    // -----
    // I18N String constants
    private static final String PROGRESS_STRING = NbBundle.getMessage(ProfilerProgressDisplayer.class,
                                                                      "ProgressDisplayer_ProgressString"); // NOI18N
    private static final String CANCEL_BUTTON_TEXT = NbBundle.getMessage(ProfilerProgressDisplayer.class,
    ...
    // --- Public interface ------------------------------------------------------
    public static ProfilerProgressDisplayer showProgress(String message) {
        return showProgress(message, null);
    }

    public static ProfilerProgressDisplayer showProgress(String message, Cancellable controller) {
        return showProgress(PROGRESS_STRING, message, controller);
    }

    public static ProfilerProgressDisplayer showProgress(String caption, String message, Cancellable controller) {
        synchronized (displayerLock) {
            final ProfilerProgressDisplayer pd = ProfilerProgressDisplayer.getDefault();
    ...
    private DialogDescriptor createDialogDescriptor(String caption, String message, Cancellable controller) {

...
import org.netbeans.modules.profiler.ui.wizards.providers.WizardIntegrationProvider;
...
public class AttachSettingsPanel extends AttachWizardPanel {
    ...
    public class PanelModel {
        ...
        public PanelModel() {
            Result result = Lookup.getDefault().lookup(new Lookup.Template(WizardIntegrationProvider.class));

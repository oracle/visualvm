...
public class ReviewSettingsPanel extends AttachWizardPanel {
    ...
    private String buildSummary(AttachSettings attachSettings) {
        ...
        attachSettingsSummaryBuffer.append(NbBundle.getMessage(AttachWizard.class, "AttachWizard_TargetTypeString")); // NOI18N
        attachSettingsSummaryBuffer.append("</b> "); // NOI18N
        ...
        if (attachSettings.isRemote()) {
            attachSettingsSummaryBuffer.append(NbBundle.getMessage(AttachWizard.class, "AttachWizard_RemoteSystemString")); // NOI18N
            attachSettingsSummaryBuffer.append("<br>"); // NOI18N
            attachSettingsSummaryBuffer.append("<b>"); // NOI18N
            attachSettingsSummaryBuffer.append(NbBundle.getMessage(AttachWizard.class, "AttachWizard_RemoteSystemHostNameString")); // NOI18N
            attachSettingsSummaryBuffer.append("</b> "); // NOI18N
            attachSettingsSummaryBuffer.append(attachSettings.getHost());
            attachSettingsSummaryBuffer.append("<br>"); // NOI18N
            attachSettingsSummaryBuffer.append("<b>"); // NOI18N
            attachSettingsSummaryBuffer.append(NbBundle.getMessage(AttachWizard.class, "AttachWizard_RemoteSystemOsString")); // NOI18N
            attachSettingsSummaryBuffer.append("</b> "); // NOI18N
            attachSettingsSummaryBuffer.append(attachSettings.getHostOS());
            attachSettingsSummaryBuffer.append("<br>"); // NOI18N
        } else {
            attachSettingsSummaryBuffer.append(NbBundle.getMessage(AttachWizard.class, "AttachWizard_LocalMachineString")); // NOI18N
            attachSettingsSummaryBuffer.append("<br>"); // NOI18N
            attachSettingsSummaryBuffer.append("<b>"); // NOI18N
            attachSettingsSummaryBuffer.append(NbBundle.getMessage(AttachWizard.class, "AttachWizard_AttachMethodString")); // NOI18N
            attachSettingsSummaryBuffer.append("</b> "); // NOI18N
            attachSettingsSummaryBuffer.append(attachSettings.isDirect()
                                               ? NbBundle.getMessage(AttachWizard.class, "AttachWizard_DirectAttachString") // NOI18N
                                               : NbBundle.getMessage(AttachWizard.class, "AttachWizard_DynamicAttachString")); // NOI18N
            attachSettingsSummaryBuffer.append("<br>"); // NOI18N
        }

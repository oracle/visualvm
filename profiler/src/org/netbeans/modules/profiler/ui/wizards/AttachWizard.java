...
import org.netbeans.modules.profiler.ui.wizards.framework.AbstractWizard;
...
import org.netbeans.modules.profiler.ui.wizards.framework.steps.CompositeWizardStep;
import org.netbeans.modules.profiler.ui.wizards.framework.steps.ProxyWizardStep;
...
import org.netbeans.modules.profiler.ui.wizards.panels.RemoteAttachSettingsPanel;
import org.netbeans.modules.profiler.ui.wizards.panels.ReviewAdditionalStepsPanel;
import org.netbeans.modules.profiler.ui.wizards.panels.ReviewSettingsPanel;
 ...
 */
public class AttachWizard extends AbstractWizard {
    //~ Static fields/initializers -----------------------------------------------------------------------------------------------

    // I18N String constants
    private static final String ATTACH_WIZARD_CAPTION = NbBundle.getMessage(AttachWizard.class, "AttachWizard_AttachWizardCaption"); // NOI18N
    private static final String STEP_INTEGRATION_TYPE = NbBundle.getMessage(AttachWizard.class,
                                                                            "AttachWizard_ChooseIntegrationTypeString"); // NOI18N
    private static final String STEP_REVIEW_ATTACHSETTINGS = NbBundle.getMessage(AttachWizard.class,
                                                                                 "AttachWizard_ReviewAttachSettingsString"); // NOI18N
    private static final String STEP_SELECT_TARGETTYPE = NbBundle.getMessage(AttachWizard.class,
                                                                             "AttachWizard_SelectTargetTypeString"); // NOI18N
    private static final String STEP_REMOTE_SETTINGS = NbBundle.getMessage(AttachWizard.class, "AttachWizard_RemoteSystemString"); // NOI18N
    private static final String STEP_DYNAMIC_SETTINGS = NbBundle.getMessage(AttachWizard.class, "AttachWizard_DynamicAttachString"); // NOI18N
    private static final String STEP_PERFORM_INTEGRATION = NbBundle.getMessage(AttachWizard.class,
                                                                               "AttachWizard_PerformIntegrationString"); // NOI18N
    private static final String STEP_REVIEW_ADDITIONALSTEPS = NbBundle.getMessage(AttachWizard.class,
                                                                                  "AttachWizard_ReviewAdditionalStepsString"); // NOI18N
    private static final String STEP_MANUAL_INTEGRATION = NbBundle.getMessage(AttachWizard.class,
                                                                              "AttachWizard_ManualIntegrationStep"); // NOI18N
    private static final String STEP_AUTOMATIC_INTEGRATION = NbBundle.getMessage(AttachWizard.class,
                                                                                 "AttachWizard_AutomaticIntegrationStep"); // NOI18N
    private static final String PROVIDER_SPECIFIC_SETTINGS = NbBundle.getMessage(AttachWizard.class,
                                                                                 "AttachWizard_ProviderSpecificSettings"); // NOI18N
    private static final String REFINE_ATTACHMENT_SETTINGS = NbBundle.getMessage(AttachWizard.class,
                                                                                 "AttachWizard_RefineAttachmentSettings"); // NOI18N
    private static final String INTEGRATE_PROFILER = NbBundle.getMessage(AttachWizard.class, "AttachWizard_IntegrateProfiler"); // NOI18N

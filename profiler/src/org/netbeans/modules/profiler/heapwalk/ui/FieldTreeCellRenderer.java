 ...
 */
public class FieldTreeCellRenderer extends EnhancedTreeCellRenderer {
    //~ Instance fields ----------------------------------------------------------------------------------------------------------
    ...
    public Component getTreeCellRendererComponentPersistent(JTree tree, Object value, boolean sel, boolean expanded,
        ...
        return super.getTreeCellRendererComponentPersistent(tree, value, sel, expanded, leaf, row, hasFocus);
    }

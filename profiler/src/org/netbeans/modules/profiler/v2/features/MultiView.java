 ...
 */
class MultiView extends JPanel {
    
//    private Component mainToolbar;
//    private Component currentToolbar;
    private final List<ProfilerToolbar> toolbars = new ArrayList();
...
//    }
    ...
    public final void addView(String name, Icon icon, String description, Component view, ProfilerToolbar toolbar) {
        if (view == null) return;
        if (tabs == null) {
            if (firstView == null) {
                firstView = view;

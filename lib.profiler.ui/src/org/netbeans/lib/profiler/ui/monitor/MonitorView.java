...
public class MonitorView extends JPanel {
    ...
    private void initUI() {
        ...
        add(CPUGraphPanel.createBigPanel(models));
        add(MemoryGraphPanel.createBigPanel(models));
        add(SurvivingGenerationsGraphPanel.createBigPanel(models));
        add(ThreadsGraphPanel.createBigPanel(models));
    }

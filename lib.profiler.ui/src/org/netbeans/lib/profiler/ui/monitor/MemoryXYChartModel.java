 ...
 */
public class MemoryXYChartModel extends VMTelemetryXYChartModel {
    ...
    private static final String HEAP_SIZE_STRING = messages.getString("MemoryXYChartModel_HeapSizeString"); // NOI18N
    private static final String HEAP_USED_STRING = messages.getString("MemoryXYChartModel_HeapUsedString"); // NOI18N
                                                                                                            // -----
    ...
    public MemoryXYChartModel(VMTelemetryDataManager vmTelemetryDataManager) {
        ...
        setupModel(new String[] { HEAP_SIZE_STRING, HEAP_USED_STRING },
    ...
    public long getLimitYValue() {
        return vmTelemetryDataManager.maxHeapSize;
    }

    // TODO: will be moved to chart axis definition
    public long getMaxDisplayYValue(int seriesIndex) {
        return Math.max(getMaxYValue(0), getMaxYValue(1));
    }

    public long[] getYValues(int seriesIndex) {
        switch (seriesIndex) {
            case 0:
                return vmTelemetryDataManager.totalMemory;
            case 1:
                return vmTelemetryDataManager.usedMemory;
        }

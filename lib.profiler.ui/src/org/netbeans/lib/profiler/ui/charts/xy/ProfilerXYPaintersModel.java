 ...
 */
public class ProfilerXYPaintersModel implements PaintersModel {

    private final ItemPainter[] painters;


    public ProfilerXYPaintersModel(ItemPainter[] painters) {
...
//            throw new UnsupportedOperationException("Unsupported item: " + item); // NOI18N
        ...
        return painters[xyItem.getItemIndex()];
    }

 ...
 */
public final class FillItemDescriptor extends XYItemDescriptor {

    public FillItemDescriptor(String name, String description) {
    ...
    public FillItemDescriptor(String name, String description,
                              ItemValueFormatter formatter, double dataFactor,
                              long minValue, long maxValue, Color fillColor1,
                              Color fillColor2) {

        super(name, description, formatter, dataFactor, minValue, maxValue, 0.0F,
              null, fillColor1, fillColor2);
    }

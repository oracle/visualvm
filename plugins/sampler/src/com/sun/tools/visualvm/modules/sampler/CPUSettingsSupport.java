...
public class CPUSettingsSupport {
    ...
    public DataViewComponent.DetailsView getDetailsView() {
        return new DataViewComponent.DetailsView(NbBundle.getMessage(ApplicationSamplerView.class, "LBL_Cpu_settings"), null, 10, new ScrollableContainer(getPanel()), null); // NOI18N
    }
    ...
    private JPanel createPanel() {
        ...
        inclFilterRadioButton = new JRadioButton(NbBundle.getMessage(ApplicationSamplerView.class, "LBL_Profile_Incl")); // NOI18N
        inclFilterRadioButton.setToolTipText(NbBundle.getMessage(ApplicationSamplerView.class, "TOOLTIP_Inclusive_Filter")); // NOI18N
        ...
        exclFilterRadioButton = new JRadioButton(NbBundle.getMessage(ApplicationSamplerView.class, "LBL_Profile_Excl")); // NOI18N
        exclFilterRadioButton.setToolTipText(NbBundle.getMessage(ApplicationSamplerView.class, "TOOLTIP_Exclusive_Filter")); // NOI18N
        ...
        filtersArea.getTextArea().setToolTipText(NbBundle.getMessage(ApplicationSamplerView.class, "TOOLTIP_Instrumentation_Filter")); // NOI18N

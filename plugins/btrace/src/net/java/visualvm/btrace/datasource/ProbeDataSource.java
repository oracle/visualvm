...
public class ProbeDataSource extends AbstractDataSource {
    ...
    private Client btraceClient;
    private InputStream is;
    
    public ProbeDataSource(ProbeConfig config, InputStream is, Application master, Client btrace) {
        super(master);
        this.config = config;
        this.application = master;
        this.btraceClient = btrace;
        this.is = is;
    }

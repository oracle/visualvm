 ...
 * @author Tomas Hurka
 */
public class ExtendedJmxSupport implements DataRemovedListener {
    private final static Logger LOGGER = Logger.getLogger(ExtendedJmxSupport.class.getName());
    ...
    ExtendedJmxSupport(Application app, ExtendedJVMImpl vm) {
        jvm = vm;
        application = app;
        ...
        synchronized (operatingSystemMXBeanLock) {
            ...
            if (jmx != null) {
                ...
                try {
                    ...
                    LOGGER.throwing(ExtendedJmxSupport.class.getName(), "getOperationSystem", ex); // NOI18N
                    return null;
                }
           }
           return operatingSystemMXBean;
    ...
    Properties getSystemProperties() {
        try {
            ...
            LOGGER.throwing(ExtendedJmxSupport.class.getName(), "getSystemProperties", e); // NOI18N
            return null;
        }
    }
    ...
    String getJvmArgs() {
        try {
            ...
            LOGGER.throwing(ExtendedJmxSupport.class.getName(), "getJvmArgs", e); // NOI18N
            return null;
        }
    }
    ...
    String takeThreadDump() {
        try {
            ...
            LOGGER.throwing(ExtendedJmxSupport.class.getName(), "takeThreadDump", e); // NOI18N
            return null;
        }
    }
    ...
    MemoryPoolMXBean getPermGenPool() {
        try {
            ...
            LOGGER.throwing(ExtendedJmxSupport.class.getName(), "getPermGenPool", e); // NOI18N
            return null;
        }
    }
            ...
            timer = new Timer(interval, new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    RequestProcessor.getDefault().post(new Runnable() {
                        public void run() {
                            try {
                                MonitoredData data = new ExtendedMonitoredDataImpl(jvm, ExtendedJmxSupport.this, jmx);
                                jvm.notifyListeners(data);
                            } catch (UndeclaredThrowableException e) {
                                LOGGER.throwing(ExtendedJmxSupport.class.getName(), "ExtendedMonitoredDataImpl<init>", e); // NOI18N
                            }
                        }
                    });
                }

 ...
 * @author Tomas Hurka
 */
public class ExtendedMonitoredDataImpl extends MonitoredData {
  private final static Logger LOGGER = Logger.getLogger(ExtendedMonitoredDataImpl.class.getName());
  final private Jvm jvm;

  private ExtendedMonitoredDataImpl(Jvm vm,ExtendedJmxSupport jmxSupport) {
    try {
        ...
        LOGGER.throwing(ExtendedMonitoredDataImpl.class.getName(), "ExtendedMonitoredDataImpl.<init>", ex); // NOI18N
    }
    jvm = vm;
  }
  
  ExtendedMonitoredDataImpl(Jvm vm,JvmJvmstatModel jvmstatModel,ExtendedJmxSupport jmxSupport) {
    this(vm,jmxSupport);
  ...
  ExtendedMonitoredDataImpl(Jvm vm,ExtendedJmxSupport jmxSupport,JvmMXBeans jmxModel) {
    this(vm,jmxSupport);

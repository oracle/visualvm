 ...
 * @author Tomas Hurka
 */
public class ExtendedJVMImpl extends Jvm implements JvmstatListener {
    ...
    ExtendedJVMImpl(Application app,JvmstatModel jvms) {
        application = app;
        monitoredVm = jvms;
        jvmstatModel = JvmJvmstatModelFactory.getJvmstatModelFor(app);
        jmxSupport = new ExtendedJmxSupport(app,this);
        listeners = new HashSet();
    }
    
    ExtendedJVMImpl(Application app) {
        application = app;
        jmxSupport = new ExtendedJmxSupport(app,this);
        listeners = new HashSet();
    }
    ...
    public boolean is17() {
        String ver = getVmVersion();
        if (ver != null && (ver.startsWith("1.7.") || ver.startsWith("11.0") || ver.startsWith("12.0") || ver.startsWith("13.0"))) {  // NOI18N
            return true;
        }
        return false;
    }
    ...
    public File takeThreadDump() throws IOException {
        ...
        if (threadDump == null) {
            ...
            threadDump = org.openide.util.NbBundle.getMessage(ExtendedJVMImpl.class, "MSG_ThreadDumpfailed");   // NOI18N
        }
        File snapshotDir = application.getStorage().getDirectory();

    ...
    public void chartDataChanged() {
        if (model != null) {
            ...
            try {
                ...
                xItems = model.getXLabels();
                yItems = model.getYValues();
                maxHeight = model.getMaxYValue();
            } finally {
            ...
            if (xItems.length  != yItems.length) {
...
//            maxHeight = getMaxY(yItems);
            ...
            if ((getFont() != null) && (getGraphics() != null) && (getGraphics().getFontMetrics() != null)) {
                ...
                horizLegendWidth = (int) getGraphics().getFontMetrics().getStringBounds(model.getXAxisDesc(), getGraphics()).getWidth();

                int maxYMarkWidth = (int) getGraphics().getFontMetrics().getStringBounds(Integer.toString(maxHeight) + "0", getGraphics()).getWidth() + 10;
                int vertLegendWidth = (int) getGraphics().getFontMetrics().getStringBounds(model.getYAxisDesc(), getGraphics()).getWidth();
    ...
    protected void drawChart(Graphics2D g2) {
        ...
        assert(xItems != null && yItems != null);

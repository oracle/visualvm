# VisualVM (2.2.2) sources repository
...
Then download and extract the [NetBeans Platform 22](https://github.com/oracle/visualvm/releases/download/2.2.2/nb220_platform_20260621.zip) into directory `visualvm/visualvm` (should create `visualvm/visualvm/netbeans`).

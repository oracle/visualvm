 ...
 */
public interface RuntimeCPUCCTNodeVisitor {
    //~ Methods ------------------------------------------------------------------------------------------------------------------

    void visit(ServletRequestCPUCCTNode node);

    void visit(ThreadCPUCCTNode node);

    void visit(MethodCPUCCTNode node);

    void visit(SimpleCPUCCTNode node);

    void visit(CategoryCPUCCTNode node);
}

 ...
 */
public interface CPUCCTVisitor extends RuntimeCPUCCTNodeVisitor {
    //~ Methods ------------------------------------------------------------------------------------------------------------------
    ...
    void visitPost(SimpleCPUCCTNode node);

    void visitPost(MethodCPUCCTNode node);

    void visitPost(ThreadCPUCCTNode node);

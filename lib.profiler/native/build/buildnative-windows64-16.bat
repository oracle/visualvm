...
link /DLL /NXCOMPAT /DYNAMICBASE /MAP:%BUILD_OUTPUT%\deployed\jdk16\windows-amd64\profilerinterface.map /OUT:%BUILD_OUTPUT%\deployed\jdk16\windows-amd64\profilerinterface.dll ^

...
public class ManualIntegrationPanelUI extends javax.swing.JPanel implements ListDataListener {
  ...
  ManualIntegrationPanelUI(ManualIntegrationPanel.Model aModel) {
    this.model = aModel;
    initComponents();
    stepsPanel.addHyperlinkListener(new HyperlinkListener() {
        public void hyperlinkUpdate(HyperlinkEvent e) {
            if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
                JFileChooser chooser = new JFileChooser();
                chooser.setDialogTitle("Choose remote pack destination folder");
                chooser.setAcceptAllFileFilterUsed(false);
                chooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
                if ((JFileChooser.CANCEL_OPTION & chooser.showSaveDialog(null)) == 0) {
                        try {
                            model.exportRemotePack(chooser.getSelectedFile().getAbsolutePath());
